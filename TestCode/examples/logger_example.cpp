...
{
	CtrlLogger& ctrl_logger = CtrlLogger::GetLogger("ctrl_log.txt", "/home/xaegrek/logtest");
	...
	CsvLogger csv_logger("csv_log", "/home/xaegrek/logtest");
	...
	for(int i = 0; i < 500; i++)
	{
		...
		GlobalCsvLogger::GetLogger("global_csv_log", "/home/xaegrek/logtest").LogData(21,34,56);
	}

	EventLogger event_logger("event_log", "/home/xaegrek/logtest");
